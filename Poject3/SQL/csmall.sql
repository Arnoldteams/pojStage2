...
CREATE TABLE `tb_order` (
  ...
  `status` int(1) DEFAULT NULL COMMENT '状态 0初始化状态 1已付款 2未发货 3已发货 4交易成功 5交易关闭 6交易失败 7-订单取消',
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_promo_session` VALUES (1, 1, '2020-05-04 10:00:00', '2020-05-04 12:00:00', '20200504');
COMMIT;
